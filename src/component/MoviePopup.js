...
//   }
  ...
  render() {
    ...
    // Pull out movie data
    const {  FilmName, Director, FilmImageUrl , days, times } = movie || {};
          ...
          <View style={styles.content}>
            ...
            >
              ...
              <View style={[styles.imageContainer, this.getStyles().imageContainer]}>
                <Image source={{ uri: FilmImageUrl }} style={styles.image} />
              </View>
              {/* Title and genre */}
              <View style={[styles.movieInfo, this.getStyles().movieInfo]}>
                <Text style={[styles.title, this.getStyles().title]}>{FilmName}</Text>
                <Text style={styles.genre}>{Director}</Text>
              </View>
            </View>
            ...
            <View>
              {/* Day */}
              <Text style={styles.sectionHeader}>روز</Text>
              <Options
  values={days}
  chosen={chosenDay}
...
/>
              {/* Time */}
              <Text style={styles.sectionHeader}>ساعت نمایش</Text>
              <Options
  values={times}
  chosen={chosenTime}
...
/>
          ...
          <View style={styles.footer}>
            <TouchableHighlight
              ...
              onPress={onBook}
            >
              <Text style={styles.button}>رزرو بلیط</Text>
            </TouchableHighlight>
          </View>
